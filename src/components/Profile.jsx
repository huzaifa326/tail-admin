      ...
      <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 bg-[#F1F5F9] dark:bg-[#1A222C]">
        <div className="mx-auto max-w-[60.625rem]">
          ...
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
              <ol className="flex items-center gap-2">
                <li>
                  <NavLink
                    className="font-medium text-text-[#64748b] dark:text-dark-general-gray"
                    to="/"
                  >
                    Dashboard /
                  </NavLink>
          ...
          <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div className="relative z-20 h-[8.75rem] md:h-[16.25rem]">
                  <img  src={`${process.env.PUBLIC_URL}/images/profile/cover-01.png`} alt="profile cover" className="h-full w-full rounded-tl-sm rounded-tr-sm object-cover object-center"/>
                ...
                <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-[2.875rem] ">
                  <div className=" relative z-30 mx-auto mt-[-5.5rem] h-[7.5rem] w-full max-w-[7.5rem] rounded-full bg-white/20 p-1 backdrop-blur sm:h-[11rem] sm:max-w-[11rem] sm:p-3">
                    <div className="relative drop-shadow-2">
                      <img  src={`${process.env.PUBLIC_URL}/images/profile/user-06.png`} alt="profile"/>
                      <label for="profile" className="absolute bottom-0 right-0 flex h-[2.125rem] w-[2.125rem] cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2">
                        <svg className="fill-current" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="font-medium text-general-gray dark:text-dark-general-gray">Ui/Ux Designer</p>
                    <div className="mx-auto mb-[1.375rem] mt-[1.125rem] grid max-w-[23.5rem] grid-cols-3 rounded-md border border-stroke py-[0.625rem] shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                      <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark sm:flex-row">
                        <span className="font-semibold text-black dark:text-white">259</span>
                        <span className="text-sm text-general-gray dark:text-dark-general-gray">Posts</span>
                      </div>
                      <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark sm:flex-row">
                        <span className="font-semibold text-black dark:text-white">129K</span>
                        <span className="text-sm text-general-gray dark:text-dark-general-gray">Followers</span>
                      </div>
                      <div className="flex flex-col items-center justify-center gap-1 px-4 sm:flex-row">
                        ...
                        <span className="text-sm text-general-gray dark:text-dark-general-gray">Following</span>
                      </div>
                    </div>
                    ...
                    <div className="mx-auto max-w-[45rem]">
                      ...
                      <p className="mt-[1.125rem] text-sm font-normal text-general-gray dark:text-dark-general-gray">
                    ...
                    <div className="mt-[1.625rem] ">
                      ...
                      <div className=" flex items-center justify-center gap-3.5">
                        <NavLink  className="text-general-gray dark:text-dark-general-gray hover:text-primary" name="social-icon" aria-label="social-icon">
