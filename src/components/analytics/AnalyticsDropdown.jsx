...
export default function AnalyticsDropdown({size}) {
  return (
    <div className="text-general-gray dark:text-dark-general-gray">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex w-full items-center justify-center  focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75">
            <BsThreeDots className={`text-general-gray dark:text-dark-general-gray text-[20px] `}  />
          </Menu.Button>
        </div>
        <Transition
          as={Fragment}
        ...
        >
          <Menu.Items className="absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border border-stroke bg-white p-1.5 shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="">
