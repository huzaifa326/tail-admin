...
const CommingSoon = () => {
  const initialDays = 256;
  const initialHours = 10;
  const initialMinutes = 35;
  const initialSeconds =
    initialDays * 24 * 60 * 60 + initialHours * 60 * 60 + initialMinutes * 60;
  ...
  return (
    <div className="bg-white px-4 dark:bg-boxdark-2 sm:px-8 overflow-hidden relative z-10">
        ...
        <div className="no-scrollbar overflow-y-auto py-20">
          <div className="mx-auto w-full max-w-[600px]">
            <div className="text-center">
              ...
              <p className="font-medium text-general-gray">
          ...
          <div className="mt-10  mx-auto ">
            <div className="flex flex-wrap gap-6 items-center justify-center mx-auto max-w-[450px] ">
              <div className="text-center  tracking-wides">
                <div className="mb-3 timer-value px-[0.75rem] py-[20px] rounded-xl  bg-[#1C2434] text-white text-[40px] leading-[2.25rem] font-black">
                  {days}
                </div>
                <span className="text-general-gray">Days</span>
              </div>
              ...
              <div className="text-center tracking-widest	">
                ...
                <span className="text-general-gray">Hours</span>
              </div>
              ...
              <div className="text-center tracking-widest	  ">
                ...
                <span className="text-general-gray">Minutes</span>
              </div>

              <div className="text-center tracking-widest">
                <div className="mb-3 rounded-xl  bg-[#1C2434] text-white text-[40px] leading-[2.25rem] font-black timer-value px-[0.75rem] py-[20px]">
                  {remainingSeconds}
                </div>
                <span className="text-general-gray">Seconds</span>
              </div>
            </div>
          </div>
          {/* -----timer---- */}
          <div className="mx-auto mt-[3.125rem] w-full max-w-[580px]">
            <form>
              <div className="flex">
                <input
                  type="email"
                  ...
                  className="placeholder:text-dark-4 w-full rounded-l-md border-[1.5px] border-r-0 border-stroke px-[1.375rem] py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                />
                <button
                  type="submit"
          ...
          <div className="mt-10 text-center">
            ...
            <div className="flex items-center justify-center gap-4 text-general-gray ">
              <Link
                to="/"
