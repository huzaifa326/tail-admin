      ...
      <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 bg-[#F1F5F9] dark:bg-[#1A222C]">
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav>
            <ol className="flex items-center gap-2">
              ...
              <li className="font-medium text-primary">Sign Up</li>
            </ol>
          </nav>
        </div>
        {/* ========= */}
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="flex flex-wrap items-center">
            <div className="hidden w-full  dark:border-strokedark xl:block xl:w-1/2 ">
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <div className="w-full p-4 sm:p-[3.125rem] xl:p-[4.375rem]">
                <span className="mb-1.5 block font-medium text-general-gray dark:text-dark-general-gray ">
                  Start for free
                </span>
                <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-[33px] leading-[45px] ">
                ...
                <form>
                  ...
                  <div className="mt-6 text-center">
                    <p className="font-medium text-general-gray dark:text-dark-general-gray  ">
                      ...
                      <Link to="/signup" className="text-primary ms-[10px]">
                        Sign Up
                      </Link>
                    </p>
                  </div>
