      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
          <Card
            ...
            text="Total views"
            rating="0.43%"
            icon="/images/card/arrow-up.svg"
            iconClr="meta-3"
            reacticon={<CgEye className="text-[#3056d3] dark:text-white w-[22px] h-[26px] " />}
          />
          <Card
            heading="$45,2K"
            text="Total Profit"
            ...
            icon="/images/card/arrow-up.svg"
            iconClr="meta-3"
            reacticon={<BsCart2 className="text-[#3056d3] dark:text-white w-[22px] h-[26px] " />}
          />
          <Card
            heading="$2.450K"
            text="Total Product"
          ...
          <Card
            ...
            text="Total USers"
            rating="0.59%"
            icon="/images/card/arrow-down.svg"
            iconClr="meta-5"
            reacticon={<LuUsers2 className="text-[#3056d3] dark:text-white w-[22px] h-[26px] " />}
          />
        </div>
        ...
        <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
          ...
          {/*-------Chart four Started-----*/}
          <div
            className={`col-span-12 rounded-sm border bg-white border-[rgba(226,232,240,1)] dark:border-[rgba(46,58,71,1)] dark:bg-[#1C2434]  px-[1.875rem] py-6 shadow-default xl:col-span-7`}
          >
            <h4
              className={`mb-2 text-xl font-bold text-[#1c2434] dark:text-white`}
            >
              Region labels
            </h4>
            <Map />
