      ...
      <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 bg-[#F1F5F9] dark:bg-[#1A222C]">
          ...
          <nav>
            <ol className="flex items-center gap-2">
              <li className="text-general-gray dark:text-dark-general-gray">
                <NavLink className="font-medium text-general-gray dark:text-dark-general-gray">
                  Dashboard /
                </NavLink>
              </li>
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
            <div className="flex justify-between border-b border-r border-stroke px-[1.875rem] py-7 dark:border-strokedark xl:border-b-0">
              <div className="flex items-center gap-[1.375rem]">
                ...
                <div>
                  ...
                  <span className="font-medium text-general-gray dark:text-dark-general-gray ">
                    17 files
                  </span>
                </div>
              </div>
            ...
            <div className="flex justify-between border-b border-r border-stroke px-[1.875rem] py-7 dark:border-strokedark sm:border-b-0">
              <div className="flex items-center gap-[1.375rem]">
            ...
            <div className="flex justify-between px-[1.875rem] py-7">
              <div className="flex items-center gap-[1.375rem]">
        ...
        <div className="mt-[1.875rem] grid grid-cols-12 gap-4 md:gap-6 2xl:gap-[1.875rem]">
          ...
          <div className="col-span-12 xl:col-span-8">
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <div className="flex flex-col gap-2 p-4 sm:flex-row sm:justify-between md:p-6 xl:p-[1.875rem]">
                <div>
                  <h2 className="text-[26px] leading-[30px] font-bold text-black dark:text-white">
                    Activity Chart
                  </h2>
              ...
              <div className="px-[1.875rem]"><ChartTen/> </div>
            </div>
          </div>
          {/* =====Storage available==== */}
          <div className="col-span-12 xl:col-span-4">
            <div className="flex flex-col gap-4 sm:flex-row md:gap-6 xl:flex-col xl:gap-[1.875rem]">
              <div className="relative rounded-sm border border-stroke bg-white py-8 pl-[1.875rem] pr-12 shadow-default dark:border-strokedark dark:bg-boxdark xl:py-11 2xl:pl-12 2xl:pr-16">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center 2xl:gap-9">
                  <div
                    className="relative flex items-center justify-center"
                    x-data="{percent : 85}"
                  >
                    <svg className="h-[8.25rem] w-[8.25rem] -rotate-90 transform">
                      <circle
                      ...
                      <circle
                        ...
                        cx="66"
                        cy="66"
                        stroke-dasharray="364.424747816416"
                        stroke-dashoffset="54.66371217246245"
                      ></circle>
                    </svg>
                    <span
                  ...
                  <div>
                    ...
                    <p className="mt-3.5 font-medium">
                      ...
                      <span className="text-sm text-general-gray dark:text-dark-general-gray">
                        {" "}
                        GB
                      </span>{" "}
              ...
              <div className="flex-grow rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-[1.875rem]">
                <div className="flex gap-4">
                  <div className="flex h-[2.875rem] w-[2.875rem] items-center justify-center rounded-md bg-[#F6F6F8] dark:bg-graydark">
                    <svg
                      width="24"
                      height="25"
                      viewBox="0 0 24 25"
          ...
          <div className="col-span-12">
            <div className="rounded-sm border border-stroke bg-white py-3 shadow-default dark:border-strokedark dark:bg-boxdark">
              <div className="flex justify-between gap-2.5 px-6 py-3 hover:bg-gray-2 dark:hover:bg-meta-4 sm:items-center sm:justify-start">
                <div className="flex items-center gap-[1.375rem] sm:w-5/12 xl:w-3/12">
