                    ...
                    <div className="mb-[1.375rem] flex flex-col gap-[1.375rem] sm:flex-row">
                      <div className="w-full sm:w-1/2">
                        ...
                        <div className="relative">
                          <span className="absolute left-[1.125rem] top-4">
                            <svg
                          ...
                          <input
                            className="w-full rounded border border-stroke bg-gray py-3 pl-[2.875rem] pr-[1.125rem] font-medium text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                            type="text"
                            name="fullName"
                            id="fullName"
                      ...
                      <div className="w-full sm:w-1/2">
                        ...
                        <input
                          className="w-full rounded border border-stroke bg-gray px-[1.125rem] py-3 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                          type="text"
                          name="phoneNumber"
                          id="phoneNumber"
              ...
              <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div className="p-7">
                  <form action="#">
                    <div className="mb-4 flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <span className="flex gap-2.5">
                          <button className="text-sm font-medium hover:text-primary text-general-gray dark:text-dark-general-gray ">
                            Delete
                          </button>
                          <button className="text-sm font-medium hover:text-primary text-general-gray dark:text-dark-general-gray">
                            Update
                    ...
                    <div
                      id="FileUpload"
                      className="relative mb-[1.375rem] block w-full cursor-pointer appearance-none rounded border border-dashed border-primary bg-gray px-4 py-4 dark:bg-meta-4 sm:py-[1.875rem]"
                    >
                      <input
                        type="file"
                        accept="image/*"
                      ...
                      <div className="flex flex-col items-center justify-center space-y-3">
                        ...
                        <p className="mt-1.5 text-sm font-medium text-general-gray dark:text-dark-general-gray">
                          SVG, PNG, JPG or GIF
                        </p>
                        <p className="text-sm font-medium text-general-gray dark:text-dark-general-gray">
                          (max, 800 X 800px)
