    ...
    <Disclosure>
      {({ open }) => (
        <>
          ...
          <img className="w-[18px] h-[18px]" src={`${process.env.PUBLIC_URL}/images/side-bar/chart.svg`} alt="" />
          ...
          <ul className="mb-5.5 pt-4 flex flex-col gap-2.5 pl-6 cursor-pointer">
            ...
            <li><NavLink activeClassName="active" to="/basicchart" className="rounded-md px-4 font-medium duration-300 ease-in-out text-[#8a99af] hover:text-white">Basic Chart</NavLink></li>

            <li>
              <NavLink activeClassName="active" to="/advancedchart" className="relative flex items-center gap-2.5 rounded-md px-4 font-medium text-[#8a99af] duration-300 ease-in-out hover:text-white">Advanced Chart
