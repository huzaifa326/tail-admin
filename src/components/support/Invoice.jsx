      ...
      <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 bg-[#F1F5F9] dark:bg-[#1A222C]">
        <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav>
            <ol className="flex items-center gap-2">
              ...
              <li className="font-medium text-primary">Invoice</li>
            </ol>
          </nav>
        </div>
        {/* ========= */}
          ...
          <div className="p-4 sm:p-6 xl:p-9">
            <div className="flex flex-col-reverse gap-5 xl:flex-row xl:justify-between">
              <div className="flex flex-col gap-4 sm:flex-row xl:gap-9">
                <div>
                  ...
                  <h4 className="mb-4 text-[22px] font-medium leading-[30px] text-black dark:text-white">
                    Roger Culhane
                  </h4>
                  <Link
                    to="#"
                    className="block text-general-gray dark:text-dark-general-gray "
                  >
                    <span className="font-medium mr-[5px] ">Email:</span>
                    contact@example.com
                  </Link>
                  <span className="mt-2 block text-general-gray dark:text-dark-general-gray">
                    <span className="font-medium">Address:</span> 2972
                ...
                <div>
                  ...
                  <span className="mt-2 block text-general-gray dark:text-dark-general-gray">
                    <span className="font-medium">Address:</span> New York, USA
                    2707 Davis Anenue
                  </span>
                </div>
              </div>
            ...
            <div className="my-10 rounded-sm border border-stroke p-5 dark:border-strokedark">
              <div className="items-center sm:flex">
                <div className="mb-3 mr-6 h-20 w-20 sm:mb-0">
                  <img
                    src={`${process.env.PUBLIC_URL}/images/authentication/product-thumb.png`}
                    alt="product"
                ...
                <div className="w-full items-center justify-between md:flex">
                  <div className="mb-3 md:mb-0">
                    ...
                    <p className="flex text-sm font-medium text-general-gray dark:text-dark-general-gray">
            ...
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4 sm:w-1/2 xl:w-3/12">
                <div className="mb-10">
                  <h4 className="mb-4 text-[22px] font-medium leading-[30px] text-black dark:text-white md:text-2xl">
                    Shipping Method
                  </h4>
        ...
        <div className="mb-10 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="p-4 sm:p-6 xl:p-9">
            ...
            <div className="flex flex-wrap justify-between gap-5">
              <div>
                ...
                <Link
                  ...
                  className="block text-general-gray dark:text-dark-general-gray"
                >
                  <span className="font-medium mr-[5px] text-black dark:text-white">
                    Email:
                  </span>
                  contact@example.com
                </Link>
                <span className="mt-1.5 block text-general-gray dark:text-dark-general-gray">
                  <span className="mr-[5px] font-medium text-black dark:text-white">
                    Address:
                  </span>
            ...
            <div className="my-[1.875rem] grid grid-cols-1 border border-stroke dark:border-strokedark xsm:grid-cols-2 sm:grid-cols-4">
            ...
            <div className="border border-stroke dark:border-strokedark">
              <div className="max-w-full overflow-x-auto">
                <div className="min-w-[670px]">
                  ...
                  {/* <!-- product item --> */}
                  <div className="text-general-gray dark:text-dark-general-gray grid grid-cols-12 border-b border-stroke py-3.5 pl-5 pr-6 dark:border-strokedark">
                    <div className="col-span-3">
              ...
              <div className="flex justify-end p-6">
                <div className="w-full max-w-[16.25rem]">
                  ...
                  <button className="float-right mt-10 inline-flex items-center gap-2.5 rounded bg-primary px-[1.875rem] py-2.5 font-medium text-white hover:bg-opacity-90">
                    Download
                    <svg
                      className="fill-current"
                      width="18"
