        ...
        <div className="h-[calc(100vh-186px)] overflow-hidden sm:h-[calc(100vh-174px)]">
          <div className="h-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark xl:flex">
            <div className="hidden h-full flex-col xl:flex xl:w-1/4">
              {/* <!-- ====== Chat List Start --> */}
              <div className="sticky border-b border-stroke px-6 py-[1.875rem] dark:border-strokedark">
                <h3 className="text-lg font-medium text-black dark:text-white 2xl:text-xl">
                  Active Conversations
                  <span className="ml-1 rounded-md border-[.5px] border-stroke bg-gray-2 px-2 py-0.5 text-base font-medium text-black dark:border-strokedark dark:bg-[#1A222C] dark:text-white 2xl:ml-4">
                    7
                  </span>
                </h3>
              </div>
              <div className="flex max-h-full flex-col overflow-auto p-5">
                <form className="sticky mb-7">
                  <input
                    type="text"
                    className="w-full rounded border border-stroke bg-gray-2 py-2.5 pl-5 pr-10 text-sm outline-none focus:border-primary dark:border-strokedark dark:bg-[#1A222C]"
                    placeholder="Search..."
                  />
                ...
                <div className="no-scrollbar max-h-full space-y-2.5 overflow-auto">
                  ...
                  <div className="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                    <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                      ...
                      />
                      <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-white bg-success"></span>
                    </div>
                  ...
                  <div className="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                    <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                      <img
                        src={`${process.env.PUBLIC_URL}/images/dashboard/user-5.png`}
                        alt="profile"
                        className="h-full w-full object-cover object-center"
                      />
                      <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-white bg-success"></span>
                  ...
                  <div className="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                    <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                      <img
                        src={`${process.env.PUBLIC_URL}/images/profile/user-06.png`}
                        alt="profile"
                        className="h-full w-full object-cover object-center"
                      />
                      <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-white bg-success"></span>
            ...
            <div className="flex h-full flex-col border-l border-stroke dark:border-strokedark xl:w-3/4">
              {/* <!-- ====== Chat Box Start --> */}
              <div className="sticky flex items-center justify-between border-b border-stroke px-6 py-[1.125rem] dark:border-strokedark">
                <div className="flex items-center">
                  <div className="mr-[1.125rem] h-[3.25rem] w-full max-w-[3.25rem] overflow-hidden rounded-full">
                    <img
                      src={`${process.env.PUBLIC_URL}/images/dashboard/user-4.png`}
                      alt="avatar"
                      className="h-full w-full object-cover object-center"
              ...
              <div className="no-scrollbar max-h-full space-y-3.5 overflow-auto px-6 py-[1.875rem]">
                <div className="max-w-[31.25rem]">
                  <p className="mb-2.5 text-sm font-medium text-general-gray dark:text-dark-general-gray">
                    Andri Thomas
                  </p>
                  <div className="mb-2.5 rounded-2xl rounded-tl-none bg-gray px-5 py-3 dark:bg-[#1A222C]">
                ...
                <div className="ml-auto max-w-[31.25rem]">
                  ...
                  <p className="text-right text-xs font-medium text-general-gray dark:text-dark-general-gray">
                    1:55pm
                  </p>
                </div>
                <div className="max-w-[31.25rem] text-general-gray dark:text-dark-general-gray">
              ...
              <div className="sticky bottom-0 border-t border-stroke bg-white px-6 py-5 dark:border-strokedark dark:bg-boxdark">
                <form className="flex items-center justify-between space-x-[1.125rem]">
                  <div className="relative w-full">
                    <input
                      type="text"
                      placeholder="Type something here"
                      className="pr-[78px] h-[3.25rem] w-full rounded-md border border-stroke bg-gray pl-5 pr-19 font-medium text-black placeholder-body outline-none focus:border-primary dark:border-strokedark dark:bg-[#1A222C] dark:text-white"
                    />
                  ...
                  <button className="flex h-[3.25rem] w-full max-w-[3.25rem] items-center justify-center rounded-md bg-primary text-white hover:bg-opacity-90">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
