    ...
    <Layout>
      <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 bg-[#F1F5F9] dark:bg-[#1A222C]">
        ...
        <div className="flex flex-col gap-10">
          {/* Table-1 */}
          <div
            className={`rounded-sm border px-5 pb-2.5 pt-6 shadow-default sm:px-7.5 xl:pb-1 bg-white border-[rgba(226,232,240,1)] dark:bg-[#1C2434] dark:border-[rgba(46,58,71,1)]`}
          >
            <h4
              className={`mb-6 text-xl font-bold text-[#1c2434] dark:text-white`}
            >
              Top Channels
            </h4>
            ...
            <div className="flex flex-col">
              <div
                className={`grid grid-cols-3 rounded-sm sm:grid-cols-5 bg-[#F7F9FC] text-[#64748b] dark:bg-[#313D4A] dark:text-[#aeb7c0]`}
              >
              ...
              <div className="grid grid-cols-3 border-b border-[rgba(226,232,240,1)] dark:border-strokedark sm:grid-cols-5">
                <div className="flex items-center gap-3 p-2.5 xl:p-5">
                  ...
                  <p
                    className={`hidden font-medium sm:block text-[#1c2434] dark:text-white`}
                  >
                    Google
                  </p>
                </div>
                ...
                <div className="flex items-center justify-center p-2.5 xl:p-5">
                  <p className={`font-medium text-[#1c2434] dark:text-white`}>
                    3.5K
                  </p>
                </div>
          ...
          <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            <div className="max-w-full overflow-x-auto">
              <table className="w-full table-auto">
                <thead className="bg-[#F7F9FC] text-[#64748b] dark:bg-[#313D4A] dark:text-[#aeb7c0]">
                ...
                <tbody>
                  <tr>
                    <td className="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                      ...
                      <p className="text-sm text-general-gray dark:text-dark-general-gray ">
                        $0.00
                      </p>
                    </td>
                    ...
                    <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                      <p className="inline-flex rounded-full px-3 py-1 text-sm font-medium bg-[#E8F4ED] dark:bg-[#233A41] text-[#21924B]">
                        Paid
                      </p>
                    </td>
                    <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark text-general-gray dark:text-dark-general-gray">
                  ...
                  <tr>
                    ...
                    <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                      <p className="inline-flex rounded-full bg-[#FBECED] dark:bg-[#363241] px-3 py-1 text-sm font-medium text-[#D34052]">
                        Unpaid
                      </p>
                    </td>
                    <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark text-general-gray dark:text-dark-general-gray">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-5">
                      <p className="inline-flex rounded-full bg-[#FFF6E6] dark:bg-[#3A3C3A] px-3 py-1 text-sm font-medium text-[#FF9D29]">
                        Pending
                      </p>
                    </td>
                    <td className="px-4 py-5 text-general-gray dark:text-dark-general-gray ">
                      <div className="flex items-center space-x-3.5">
                        <button className="hover:text-primary">
                          <svg
                            className="fill-current"
