    ...
    <Layout>
      <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 bg-[#F1F5F9] dark:bg-[#1A222C]">
        <div className="mx-auto max-w-5xl">
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
              <ol className="flex items-center gap-2">
                ...
                <li className="font-medium text-primary">Kanban</li>
              </ol>
            </nav>
          </div>
          {/* ========= */}
          ...
          {/* ========= */}
          <div className="mt-9 grid grid-cols-1 gap-[1.875rem] sm:grid-cols-2 xl:grid-cols-3">
            {/* <!-- Todo list --> */}
            ...
            <div className="swim-lane flex flex-col gap-[1.375rem]">
              ...
              >
                <div>
                  ...
                  <p className="text-general-gray dark:text-dark-general-gray ">
                    Dedicated form for a category of users that will perform.
                  </p>

                  <div className="my-4">
                    <img
                      src={`${process.env.PUBLIC_URL}/images/task/task-01.jpg`}
                      alt="Task"
                    />
                  </div>
